    ...
    return (
            ...
            <div className="col-12">
                ...
                <div className="container-fluid px-0">
                    <a className="navbar-brand font-weight-bolder ms-sm-3 text-primary" href="#" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom" target="_blank">
                        <img className="img img-fluid" style={{ 'width' : '50px' }} src="/affichage/logo.png" alt=""/>{Asoociation.Nom}
                    </a>
        ...
        <li className="nav-item ms-lg-auto">
          <a className="nav-link nav-link-icon me-2" href="#accueil">
            ...
            <p className="d-inline text-lg z-index-1 font-weight-bold text-info " data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tongasoa" style={{"borderBottom":"1px solid blue"}}>Acceuil</p>
          </a>
        </li>
        <li className="nav-item ms-lg-auto">
          ...
          <li className="nav-item ms-lg-auto">
            <a className="nav-link nav-link-icon me-2" href="#qui">
              ...
              <p className="d-inline text-lg text-info z-index-1 font-weight-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Iza moa izahay" style={{"borderBottom":"1px solid blue"}}>Qui somme nous</p>
            </a>
          </li>
          <li className="nav-item ms-lg-auto">
          ...
          <li className="nav-item ms-lg-auto">
            <a className="nav-link nav-link-icon me-2" href="#evenement" >
              <i className="fas fa-mail-bulk"></i>
              <p className="d-inline text-lg text-info z-index-1 font-weight-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Fifandraisana" style={{"borderBottom":"1px solid blue"}}>Evenement</p>
            </a>
          </li>
      </ul>
      <a href="/login" className="btn btn-sm  bg-gradient-warning  mb-0 me-1 mt-2 mt-md-0 d-flex gap-1 align-items-center justity-content-center"><i className="fas fa-user-circle fs-6"> </i>  SE CONNECTER</a>
    </div>
  </div>
</nav>
</div></div></div>
