...
import ListeTypeEvenement from "./ListeTypeEvenement"
import ModifierTypeEvenement from "./ModificationtypeEvenement"
import InsertionTypeEvenement from "./InsertionTypeEvenement"
    ...
    <>
      <div className="card">
              ...
              <div className="card-body">
                {page === 0 && <ListeTypeEvenement />}
                {page === 1 && <ModifierTypeEvenement />}
                {page === 2 && <InsertionTypeEvenement />}
              </div>
            </div>
    </>
  )
